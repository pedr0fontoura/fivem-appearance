...
export const SETTINGS_INITIAL_STATE: AppearanceSettings = {
  ...
  props: [
    { prop_id: 0, drawable: { min: 0, max: 255 }, texture: { min: 0, max: 255 } },
    { prop_id: 1, drawable: { min: 0, max: 255 }, texture: { min: 0, max: 255 } },
    { prop_id: 2, drawable: { min: 0, max: 255 }, texture: { min: 0, max: 255 } },
    { prop_id: 6, drawable: { min: 0, max: 255 }, texture: { min: 0, max: 255 } },
    { prop_id: 7, drawable: { min: 0, max: 255 }, texture: { min: 0, max: 255 } },
  ],
  headBlend: {
    shape: {
      min: 0,
